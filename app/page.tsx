      ...
      <main className="mx-auto max-w-[1400px] px-5 md:px-[70px]">
        ...
        <FadeInSection>
          <Section id="about" className="mt-[100px]">
            <div className="intro-card mx-auto max-w-[800px] text-center">
                <h2 className="text-[33px] mb-[25px] font-bold">Our Mission: Redefining Streaming</h2>
        ...
        <FadeInSection>
          <Section id="values" variant="secondary" className="mt-[100px]">
            <h2 className="text-[33px] font-bold mb-[50px]">Why choose FairPlay?</h2>
            <FeatureGrid />
          </Section>
        </FadeInSection>
        ...
        <FadeInSection>
          <Section id="development" variant="secondary" className="mt-[100px]">
              <h2 className="text-[33px] mb-[25px] font-bold">FairPlay: An open and evolving project</h2>
              ...
              <div className="flex flex-col lg:flex-row justify-center gap-5">
                <Button onClick={() => window.location.href="https://github.com/FairPlayTeam"}> Source code on GitHub</Button>
                <Button onClick={() => window.location.href="/docs#api"}> API Documentation</Button>
                <Button onClick={() => window.location.href="/contributors"}> Contribution guide</Button>
              </div>
          </Section>
        </FadeInSection>
