          ...
          <Section id="about" className="mt-[100px]">
            <div className="intro-card mx-auto max-w-[800px] text-center">
              ...
              <p className="text-[18px] text-(--color-medium-gray)">
                ...
                comes from bots, <b>52%</b> of internet content is generated by
                AI, and <b>71%</b> of images on social media like YouTube are
                also AI-generated. Between deepfakes, misinformation, and the
                flood of fast-paced content, we can ask ourselves:{" "}
              ...
              <div className="flex-1 w-full">
                ...
                <ul className="mb-[35px] flex flex-col items-start">
                  <li className="flex items-center text-[16px] mb-2.5">
                    <FaCheckCircle className="text-(--color-accent) text-[18px] mr-2.5" />{" "}
            ...
            <div className="flex flex-col lg:flex-row gap-[50px] text-left lg:items-center">
              <div className="flex flex-1 flex-col justify-center items-center lg:items-start text-center lg:text-left">
                ...
                <p className="text-[18px] mb-[25px] max-w-lg">
                  FairPlay is more than a platform, it's a movement. By joining
                  our community, you contribute to shaping the future of
