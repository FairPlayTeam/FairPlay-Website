  ...
  return (
    ...
    >
      <div className="text-center mb-4">
        <h1 className="py-3 text-3xl font-semibold text-(--color-accent)">
          FairPlay
        </h1>
      </div>
      ...
      <div className="space-y-3">
        <label className="flex items-center">
          <input
            ...
            defaultChecked
            id="ytShorts"
            className="mr-3 accent-(--color-accent-dark)"
          />
      ...
      <h4 className="mt-6 mb-2 text-(--color-text-bold) font-medium">
        Custom website
      </h4>
      <input
        type="text"
      ...
      <ul
        id="customDomainList"
        className="list-none p-0 mt-3 text-(--color-text-para)"
      />
