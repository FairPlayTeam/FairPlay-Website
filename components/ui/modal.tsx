          ...
          <div className="relative z-10 w-full flex min-h-screen items-end justify-center md:p-4 sm:items-center pointer-events-none">
            ...
            >
              <div className="flex flex-col gap-4 p-5 sm:p-6 overflow-hidden">
                {(title || description || showCloseButton) && (
                  <div className="flex items-start justify-between gap-4 shrink-0">
                    <div className="space-y-1">
                      {title && (
                        <h2 id={titleId} className="text-lg font-bold text-foreground mb-1">
                          {title}
                        </h2>
                      )}
                      {description && (
                    ...
                    {showCloseButton && (
                      <button
                        ...
                        className="rounded-full flex items-center justify-center size-8 bg-white/5 text-muted-foreground transition-all hover:text-foreground hover:bg-white/10 cursor-pointer"
                      >
                ...
                <div className="overflow-y-auto flex-1 h-full min-h-0">{children}</div>
              </div>
            </motion.div>
          </div>
        </div>
